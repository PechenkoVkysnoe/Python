...
from lab2.constants import NULL, TRUE, FALSE, QUOTATION_MARK, EXTRA_ATTRIBUTE_CLASS_CODE
...
def get_bases_class(obj, indent, new_indent):
    ...
    result = lab2.DeserializerJson.deserialize_list(data, 0)[0]
...
def get_code_class(obj, indent, new_indent):
    if obj.__name__ != 'object':
        ...
        result = lab2.DeserializerJson.deserialize_dict(data, 0)[0]
